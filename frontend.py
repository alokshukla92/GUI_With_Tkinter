"""
A program that stores the information of this book:
Title, Author
Year, ISBN
...
def view_command():
    ...
    for row in backend.view():
        list1.insert(END, row)  ### new rows will be printed at the end of the list box
...
b6 = Button(window, text = 'Clear All', width = 12, command = clear_all_command)
b6.grid(row = 7, column = 3)

b7 = Button(window, text = 'Close', width = 12, command = window.destroy)
b7.grid(row = 8, column = 3, pady = 5)
